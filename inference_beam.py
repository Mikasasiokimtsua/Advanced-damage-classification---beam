...
CRIT_SUB = {18:[0], 19:[3,4,6,8], 20:[1,5,7,9,10]}
...
def main(args):
    ...
    crit_B = build_criteria_head(args.critB_ckpt, 4, base_backbone).to(device)
...
if __name__=="__main__":
    ...
    ap.add_argument("--class_ckpt", default="beam_class.pth")
    ap.add_argument("--critB_ckpt",  default="beam_criteria_B.pth")
